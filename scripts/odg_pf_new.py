...
class ODGPF:
    def __init__(self):
        ...
        self.lap_time = 0
        self.lap = 0
        self.recording = open('/home/nurdy/f1tenth_ws/src/local_planning_gnu/utill/recording.csv', 'a')
    ...
    def main_drive(self, goal):
        ...
        self.set_speed = self.speed_controller(steering_angle) # determin_speed
