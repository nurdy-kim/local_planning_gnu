...
class ODGPF:
    def __init__(self):
        ...
        self.idx_temp = 0
        self.braking = False
        self.braking_dist_past = 0
        self.min_angle = 0.001
    ...
    def main_drive(self, goal):
        ...
        if controlled_angle == 0.0:
           controlled_angle = self.min_angle
        #distance = 1.5
        path_radius = self.LOOK / (2 * np.sin(controlled_angle))
        ...
        self.set_speed = self.speed_controller(self.scan_filtered, steering_angle) # determin_speed
        # if (self.set_speed < self.current_speed) and (self.current_speed > 8):
        #     steering_angle = 0.0
        #     print('check',self.set_speed - self.current_speed)
    ...
    def driving(self):
        ...
        while not rospy.is_shutdown():
            ...
            if i % 10 == 0:
                ...
                # plt.xticks([0,480,960,1540,2020,2400])
                # plt.legend(bbox_to_anchor=(1,1))
                # plt.grid()
